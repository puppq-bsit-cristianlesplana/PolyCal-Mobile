...
class MainScreen(Screen):
    ...
    def load_events(self):
        ...
        if month_events:
            ...
            no_events_label = Label(
                text=f"No events for {calendar.month_name[self.current_month]}",
                color=(0.5, 0.5, 0.5, 1),
                font_size='16sp',
                halign='center',
                valign='middle'
    ...
    def create_event_card(self, event):
        ...
        title_label = Label(
            ...
            halign='left',
            valign='middle',
            color=(0.15, 0.15, 0.15, 1),  # Dark text
            size_hint_x=0.8
        )
...
class AddEventScreen(Screen):
    ...
    def build_ui(self):
        ...
        self.desc_input = TextInput(
            hint_text="Enter event description (max 200 characters)",
            multiline=True,
            size_hint_y=None,
            height=dp(90),
            font_size='14sp'
    ...
    def add_additional_fields_section(self, parent_layout):
        # Event link
        link_section = BoxLayout(orientation='vertical', spacing=dp(5), size_hint_y=None, height=dp(70))
        link_label = Label(
            text="Event Link (optional)",
            size_hint_y=None,
            height=dp(25),
            halign='left',
            font_size='14sp',
        ...
        self.link_input = TextInput(
            hint_text="Enter event link (optional)",
            multiline=False,
            size_hint_y=None,
            height=dp(40),
            font_size='14sp'
        ...
        link_section.add_widget(link_label)
        link_section.add_widget(self.link_input)
        parent_layout.add_widget(link_section)
...
class AddNoteScreen(Screen):
    ...
    def build_ui(self):
        ...
        self.title_input = TextInput(
            hint_text="Enter note title (max 50 characters)",
            multiline=False,
            size_hint_y=None,
            height=dp(40),
            background_normal='',
        ...
        self.note_input = TextInput(
            hint_text="Enter your note here (max 200 characters)",
            multiline=True,
            size_hint_y=None,
            height=dp(160),
            font_size='14sp'
